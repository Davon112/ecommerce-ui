  ...
  return (
    ...
    <Form noValidate validated={validated} onSubmit={handleSubmit} className="border border-white rounded p-4">
      ...
      >
        ...
        <Form.Control type="text" size="sm" id="name" name="name" placeholder="Name here" onChange={handleChange} required/>
      ...
      <FloatingLabel
        ...
        className="mb-3 text-dark"
      >
        <Form.Control type="price" id="price" name="price" placeholder="Amount here" onChange={handleChange} required/>
        <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
      ...
      <FloatingLabel
        ...
        className="mb-3 text-dark"
      >
        <Form.Control type="text" id="description" name="description" placeholder="Description here" onChange={handleChange} required/>
        <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
        <Form.Control.Feedback type="invalid">Please Enter a Valid Description</Form.Control.Feedback>
      </FloatingLabel>
